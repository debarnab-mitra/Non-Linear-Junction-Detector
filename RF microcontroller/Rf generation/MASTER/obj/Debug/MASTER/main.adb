...
S:Lmain.pwrmgmt_irq$pc$1$233({1}SC:U),R,0,0,[r7]
S:Lmain.wakeup_callback$desc$1$268({2}DX,STwtimer_desc:S),R,0,0,[]
S:Lmain._sdcc_external_startup$c$2$272({1}SC:U),R,0,0,[]
S:Lmain._sdcc_external_startup$p$2$272({1}SC:U),R,0,0,[]
S:Lmain._sdcc_external_startup$c$2$273({1}SC:U),R,0,0,[]
S:Lmain._sdcc_external_startup$p$2$273({1}SC:U),R,0,0,[]
S:Lmain.main$saved_button_state$1$276({1}SC:U),E,0,0
S:Lmain.main$i$1$276({1}SC:U),R,0,0,[r7]
S:Lmain.main$x$4$293({1}SC:U),R,0,0,[r6]
S:Lmain.main$flg$3$297({1}SC:U),R,0,0,[r6]
S:Lmain.main$flg$3$300({1}SC:U),R,0,0,[r7]
...
S:Lmain.transmit_packet$demo_packet_$1$235({6}DA6d,SC:U),F,0,0
...
S:Fmain$__str_1$0$0({26}DA26d,SC:S),D,0,0
S:Fmain$__str_2$0$0({14}DA14d,SC:S),D,0,0
S:Fmain$__str_3$0$0({7}DA7d,SC:S),D,0,0
S:Fmain$__str_4$0$0({9}DA9d,SC:S),D,0,0
S:Fmain$__str_5$0$0({10}DA10d,SC:S),D,0,0
