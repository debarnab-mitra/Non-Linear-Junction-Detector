...
_coldstart::
	.ds 1
Lmain.main$saved_button_state$1$276==.
_main_saved_button_state_1_276:
	.ds 1
;--------------------------------------------------------
...
_wakeup_desc::
	.ds 8
Lmain.transmit_packet$demo_packet_$1$235==.
_transmit_packet_demo_packet__1_235:
	.ds 6
;--------------------------------------------------------
...
;------------------------------------------------------------
;saved_button_state        Allocated with name '_main_saved_button_state_1_276'
...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$main.c$312$1$276 ==.
;	main.c:312: static uint8_t __data saved_button_state = 0xFF;
	mov	_main_saved_button_state_1_276,#0xff
	C$main.c$88$1$276 ==.
;	main.c:88: uint16_t __data pkt_counter = 0;
	clr	a
	mov	_pkt_counter,a
	mov	(_pkt_counter + 1),a
	C$main.c$89$1$276 ==.
;	main.c:89: uint8_t __data coldstart = 1; // caution: initialization with 1 is necessary! Variables are initialized upon _sdcc_external_startup returning 0 -> the coldstart value returned from _sdcc_external startup does not survive in the coldstart case
	mov	_coldstart,#0x01
	.area GSFINAL (CODE)
...
;------------------------------------------------------------
	...
	C$main.c$100$0$0 ==.
;	main.c:100: static void pwrmgmt_irq(void) __interrupt(INT_POWERMGMT)
;	-----------------------------------------
...
_pwrmgmt_irq:
	...
	mov	psw,#0x00
	C$main.c$102$1$0 ==.
;	main.c:102: uint8_t pc = PCON;
	C$main.c$103$1$233 ==.
;	main.c:103: if (!(pc & 0x80))
	mov	a,_PCON
	mov	r7,a
	jb	acc.7,00102$
	C$main.c$104$1$233 ==.
...
;------------------------------------------------------------
;demo_packet_              Allocated with name '_transmit_packet_demo_packet__1_235'
;------------------------------------------------------------
	Fmain$transmit_packet$0$0 ==.
	C$main.c$111$1$233 ==.
;	main.c:111: static void transmit_packet(void)
;	-----------------------------------------
;	 function transmit_packet
;	-----------------------------------------
_transmit_packet:
	C$main.c$115$1$235 ==.
;	main.c:115: ++pkt_counter;
	inc	_pkt_counter
	clr	a
...
00108$:
	C$main.c$128$1$235 ==.
;	main.c:128: memcpy(demo_packet_, demo_packet, sizeof(demo_packet));
	...
	mov	dptr,#_transmit_packet_demo_packet__1_235
	mov	b,#0x00
	lcall	_memcpy
	C$main.c$130$1$235 ==.
;	main.c:130: if (framing_insert_counter) {
	mov	dptr,#_framing_insert_counter
	clr	a
	movc	a,@a+dptr
	jz	00102$
	C$main.c$131$2$236 ==.
;	main.c:131: demo_packet_[framing_counter_pos] = pkt_counter & 0xFF ;
	mov	dptr,#_framing_counter_pos
	clr	a
	movc	a,@a+dptr
	mov	r7,a
	add	a,#_transmit_packet_demo_packet__1_235
	mov	dpl,a
	clr	a
	addc	a,#(_transmit_packet_demo_packet__1_235 >> 8)
	mov	dph,a
	mov	r5,_pkt_counter
	mov	r6,#0x00
	mov	a,r5
	movx	@dptr,a
	C$main.c$132$2$236 ==.
;	main.c:132: demo_packet_[framing_counter_pos+1] = (pkt_counter>>8) & 0xFF;
	mov	a,r7
	inc	a
	add	a,#_transmit_packet_demo_packet__1_235
	mov	dpl,a
...
00102$:
	C$main.c$134$1$235 ==.
;	main.c:134: axradio_transmit(&remoteaddr, demo_packet_, sizeof(demo_packet));
	mov	_axradio_transmit_PARM_2,#_transmit_packet_demo_packet__1_235
	mov	(_axradio_transmit_PARM_2 + 1),#(_transmit_packet_demo_packet__1_235 >> 8)
...
;------------------------------------------------------------
	...
	C$main.c$137$1$235 ==.
;	main.c:137: static void display_transmit_packet(void)
;	-----------------------------------------
;	 function display_transmit_packet
;	-----------------------------------------
_display_transmit_packet:
	C$main.c$139$1$238 ==.
;	main.c:139: if (pkt_counter == 1) {
	mov	a,#0x01
	cjne	a,_pkt_counter,00126$
	dec	a
	cjne	a,(_pkt_counter + 1),00126$
	sjmp	00127$
00126$:
	sjmp	00109$
00127$:
	C$main.c$143$2$239 ==.
;	main.c:143: if (DBGLNKSTAT & 0x10)
	mov	a,_DBGLNKSTAT
	jnb	acc.4,00109$
	C$main.c$144$2$239 ==.
;	main.c:144: dbglink_writestr("TX : \n");
	mov	dptr,#___str_0
	mov	b,#0x80
	lcall	_dbglink_writestr
	C$main.c$147$1$238 ==.
;	main.c:147: display_setpos(0x4c);
00109$:
	C$main.c$150$1$238 ==.
;	main.c:150: if (DBGLNKSTAT & 0x10) {
	mov	a,_DBGLNKSTAT
	jnb	acc.4,00115$
	C$main.c$151$2$244 ==.
;	main.c:151: dbglink_writehex16(pkt_counter, 4, WRNUM_PADZERO);
	mov	a,#0x08
	push	acc
	rr	a
	push	acc
...
;------------------------------------------------------------
	...
	C$main.c$158$1$238 ==.
;	main.c:158: void axradio_statuschange(struct axradio_status __xdata *st)
;	-----------------------------------------
;	 function axradio_statuschange
;	-----------------------------------------
_axradio_statuschange:
	C$main.c$169$1$246 ==.
;	main.c:169: switch (st->status)
	mov	r6,dpl
	mov  r7,dph
	movx	a,@dptr
	mov	r5,a
...
;	main.c:214: break;
	C$main.c$224$2$247 ==.
;	main.c:224: case AXRADIO_STAT_CHANNELSTATE:
	sjmp	00166$
00150$:
	C$main.c$225$2$247 ==.
;	main.c:225: if (st->u.cs.busy)
	mov	a,#0x06
	add	a,r6
	mov	r6,a
	clr	a
...
;------------------------------------------------------------
	...
	C$main.c$235$1$246 ==.
;	main.c:235: static void wakeup_callback(struct wtimer_desc __xdata *desc)
;	-----------------------------------------
;	 function wakeup_callback
;	-----------------------------------------
_wakeup_callback:
	C$main.c$239$1$269 ==.
;	main.c:239: wakeup_desc.time += WTIMER0_PERIOD;
	...
	movx	@dptr,a
	C$main.c$240$1$269 ==.
;	main.c:240: wtimer0_addabsolute(&wakeup_desc);
	mov	dptr,#_wakeup_desc
	lcall	_wtimer0_addabsolute
	C$main.c$241$1$269 ==.
;	main.c:241: transmit_packet();
	lcall	_transmit_packet
	C$main.c$242$1$269 ==.
;	main.c:242: display_transmit_packet();
...
;------------------------------------------------------------
	...
	C$main.c$258$1$269 ==.
;	main.c:258: uint8_t _sdcc_external_startup(void)
;	-----------------------------------------
;	 function _sdcc_external_startup
;	-----------------------------------------
__sdcc_external_startup:
	C$main.c$261$1$271 ==.
;	main.c:261: LPXOSCGM = 0x8A;
	mov	dptr,#_LPXOSCGM
	mov	a,#0x8a
	movx	@dptr,a
	C$main.c$262$2$272 ==.
;	main.c:262: wtimer0_setclksrc(WTIMER0_CLKSRC, WTIMER0_PRESCALER);
	mov	dpl,#0x09
	lcall	_wtimer0_setconfig
	C$main.c$263$2$273 ==.
;	main.c:263: wtimer1_setclksrc(CLKSRC_FRCOSC, 7);
	mov	dpl,#0x38
	lcall	_wtimer1_setconfig
	C$main.c$265$1$271 ==.
;	main.c:265: LPOSCCONFIG = 0x09; // Slow, PRESC /1, no cal. Does NOT enable LPOSC. LPOSC is enabled upon configuring WTCFGA (MODE_TX_PERIODIC and receive_ack() )
	mov	dptr,#_LPOSCCONFIG
	mov	a,#0x09
	movx	@dptr,a
	C$main.c$267$1$271 ==.
;	main.c:267: coldstart = !(PCON & 0x40);
	mov	a,_PCON
	mov	c,acc[6]
	cpl	c
	...
	mov	_coldstart,a
	C$main.c$269$1$271 ==.
;	main.c:269: ANALOGA = 0x18; // PA[3,4] LPXOSC, other PA are used as digital pins
	mov	dptr,#_ANALOGA
	mov	a,#0x18
	movx	@dptr,a
	C$main.c$285$1$271 ==.
;	main.c:285: PORTA = 0xFF; //
	mov	_PORTA,#0xff
	C$main.c$286$1$271 ==.
;	main.c:286: PORTB = 0xFD | (PINB & 0x02); // init LEDs to previous (frozen) state
	mov	a,#0x02
	anl	a,_PINB
	orl	a,#0xfd
	mov	_PORTB,a
	C$main.c$287$1$271 ==.
;	main.c:287: PORTC = 0xFF; //
	mov	_PORTC,#0xff
	C$main.c$288$1$271 ==.
;	main.c:288: PORTR = 0x0B; //
	mov	_PORTR,#0x0b
	C$main.c$290$1$271 ==.
;	main.c:290: DIRA = 0x00; //
	mov	_DIRA,#0x00
	C$main.c$291$1$271 ==.
;	main.c:291: DIRB = 0x0e; //  PB1 = LED; PB2 / PB3 are outputs (in case PWRAMP / ANSTSEL are used)
	mov	_DIRB,#0x0e
	C$main.c$292$1$271 ==.
;	main.c:292: DIRC = 0x00; //  PC4 = button
	mov	_DIRC,#0x00
	C$main.c$293$1$271 ==.
;	main.c:293: DIRR = 0x15; //
	mov	_DIRR,#0x15
	C$main.c$296$1$271 ==.
;	main.c:296: axradio_setup_pincfg1();
...
;	main.c:299: EIE = 0x00;
	mov	_EIE,#0x00
	C$main.c$300$1$271 ==.
;	main.c:300: E2IE = 0x00;
	mov	_E2IE,#0x00
	C$main.c$302$1$271 ==.
;	main.c:302: GPIOENABLE = 1; // unfreeze GPIO
	mov	dptr,#_GPIOENABLE
	mov	a,#0x01
	movx	@dptr,a
	C$main.c$306$1$271 ==.
;	main.c:306: return !coldstart; // coldstart -> return 0 -> var initialization; start from sleep -> return 1 -> no var initialization
	mov	a,_coldstart
	cjne	a,#0x01,00111$
00111$:
	mov  __sdcc_external_startup_sloc0_1_0,c
...
;	main.c:326: EA = 1;
	setb	_EA
	C$main.c$327$1$276 ==.
;	main.c:327: flash_apply_calibration();
	lcall	_flash_apply_calibration
	C$main.c$328$1$276 ==.
;	main.c:328: CLKCON = 0x00;
	mov	_CLKCON,#0x00
	C$main.c$329$1$276 ==.
;	main.c:329: wtimer_init();
	lcall	_wtimer_init
	C$main.c$332$1$276 ==.
;	main.c:332: dbglink_init();
	lcall	_dbglink_init
	C$main.c$335$1$276 ==.
;	main.c:335: if (coldstart) {
	mov	a,_coldstart
	jnz	00209$
	ljmp	00145$
00209$:
...
;	main.c:337: led0_off();
	clr	_PORTB_1
	C$main.c$342$2$277 ==.
;	main.c:342: wakeup_desc.handler = wakeup_callback;
	...
	movx	@dptr,a
	C$main.c$350$2$277 ==.
;	main.c:350: i = axradio_init();
	lcall	_axradio_init
	C$main.c$351$2$277 ==.
;	main.c:351: if (i != AXRADIO_ERR_NOERROR) {
	mov	a,dpl
	mov	r7,a
	jz	00134$
	C$main.c$352$3$288 ==.
;	main.c:352: if (i == AXRADIO_ERR_NOCHIP) {
	cjne	r7,#0x05,00211$
	sjmp	00212$
00211$:
	ljmp	00153$
00212$:
	C$main.c$355$4$289 ==.
;	main.c:355: if (DBGLNKSTAT & 0x10)
	mov	a,_DBGLNKSTAT
	jb	acc.4,00213$
	ljmp	00163$
00213$:
	C$main.c$356$4$289 ==.
;	main.c:356: dbglink_writestr("No AX5043 RF chip found \n");
	mov	dptr,#___str_1
	mov	b,#0x80
	lcall	_dbglink_writestr
	C$main.c$358$4$289 ==.
;	main.c:358: goto terminate_error;
	ljmp	00163$
	C$main.c$363$2$277 ==.
;	main.c:363: display_writestr("found AX5043\n");
00134$:
	C$main.c$365$2$277 ==.
;	main.c:365: if (DBGLNKSTAT & 0x10)
	mov	a,_DBGLNKSTAT
	jnb	acc.4,00137$
	C$main.c$366$2$277 ==.
;	main.c:366: dbglink_writestr("found AX5043\n");
	mov	dptr,#___str_2
	mov	b,#0x80
	lcall	_dbglink_writestr
00137$:
	C$main.c$368$2$277 ==.
;	main.c:368: axradio_set_local_address(&localaddr);
	mov	dptr,#_localaddr
	mov	b,#0x80
	lcall	_axradio_set_local_address
	C$main.c$369$2$277 ==.
;	main.c:369: axradio_set_default_remote_address(&remoteaddr);
	mov	dptr,#_remoteaddr
	mov	b,#0x80
	lcall	_axradio_set_default_remote_address
	C$main.c$400$2$277 ==.
;	main.c:400: if (DBGLNKSTAT & 0x10) {
	mov	a,_DBGLNKSTAT
	jnb	acc.4,00141$
	C$main.c$401$3$292 ==.
;	main.c:401: dbglink_writestr("RNG = ");
	mov	dptr,#___str_3
	mov	b,#0x80
	lcall	_dbglink_writestr
	C$main.c$402$3$292 ==.
;	main.c:402: dbglink_writenum16(axradio_get_pllrange(), 2, 0);
	...
	dec	sp
	C$main.c$404$4$293 ==.
;	main.c:404: uint8_t x = axradio_get_pllvcoi();
	lcall	_axradio_get_pllvcoi
	C$main.c$405$4$293 ==.
;	main.c:405: if (x & 0x80) {
	mov	a,dpl
	mov	r6,a
	jnb	acc.7,00139$
	C$main.c$406$5$294 ==.
;	main.c:406: dbglink_writestr("\nVCOI = ");
	mov	dptr,#___str_4
	mov	b,#0x80
	push	ar6
	lcall	_dbglink_writestr
	pop	ar6
	C$main.c$407$5$294 ==.
;	main.c:407: dbglink_writehex16(x, 2, 0);
	clr	a
	mov	r5,a
	push	acc
	mov	a,#0x02
...
00139$:
	C$main.c$410$3$292 ==.
;	main.c:410: dbglink_writestr("\n\nMASTER\n");
	mov	dptr,#___str_5
	mov	b,#0x80
	lcall	_dbglink_writestr
00141$:
	C$main.c$415$2$277 ==.
;	main.c:415: i = axradio_set_mode(RADIO_MODE);
	mov	dpl,#0x10
	lcall	_axradio_set_mode
	C$main.c$416$2$277 ==.
;	main.c:416: if (i != AXRADIO_ERR_NOERROR)
	mov	a,dpl
	mov	r7,a
	jnz	00153$
	C$main.c$420$2$277 ==.
;	main.c:420: wakeup_desc.time = WTIMER0_PERIOD;
	mov	dptr,#(_wakeup_desc + 0x0004)
	mov	a,#0x1a
	movx	@dptr,a
	clr	a
	...
	movx	@dptr,a
	C$main.c$421$2$277 ==.
;	main.c:421: wtimer0_addrelative(&wakeup_desc);
	mov	dptr,#_wakeup_desc
	lcall	_wtimer0_addrelative
	sjmp	00146$
00145$:
	C$main.c$426$2$295 ==.
;	main.c:426: ax5043_commsleepexit();
	lcall	_ax5043_commsleepexit
	C$main.c$427$2$295 ==.
;	main.c:427: IE_4 = 1; // enable radio interrupt
	setb	_IE_4
00146$:
	C$main.c$429$1$276 ==.
;	main.c:429: axradio_setup_pincfg2();
	lcall	_axradio_setup_pincfg2
00161$:
	C$main.c$437$2$296 ==.
;	main.c:437: wtimer_runcallbacks();
	lcall	_wtimer_runcallbacks
	C$main.c$438$2$296 ==.
;	main.c:438: EA = 0;
	clr	_EA
	C$main.c$464$3$296 ==.
;	main.c:464: uint8_t flg = WTFLAG_CANSTANDBY;
	mov	r6,#0x02
	C$main.c$466$3$297 ==.
;	main.c:466: if (axradio_cansleep()
	push	ar6
	...
	jz	00148$
	C$main.c$468$3$297 ==.
;	main.c:468: && dbglink_txidle()
	lcall	_dbglink_txidle
	mov	a,dpl
	jz	00148$
	C$main.c$471$3$297 ==.
;	main.c:471: flg |= WTFLAG_CANSLEEP;
	mov	r6,#0x03
00148$:
	C$main.c$475$3$297 ==.
;	main.c:475: wtimer_idle(flg);
	mov	dpl,r6
	lcall	_wtimer_idle
	C$main.c$477$2$296 ==.
;	main.c:477: IE_3 = 0; // no ISR!
	clr	_IE_3
	C$main.c$478$2$296 ==.
;	main.c:478: EA = 1;
	setb	_EA
	C$main.c$481$1$276 ==.
;	main.c:481: display_radio_error(i);
	sjmp	00161$
00153$:
	C$main.c$483$1$276 ==.
;	main.c:483: dbglink_display_radio_error(i);
	mov	dpl,r7
	lcall	_dbglink_display_radio_error
	C$main.c$485$1$276 ==.
;	main.c:485: terminate_error:
00163$:
	C$main.c$487$2$299 ==.
;	main.c:487: wtimer_runcallbacks();
	lcall	_wtimer_runcallbacks
	C$main.c$489$3$299 ==.
;	main.c:489: uint8_t flg = WTFLAG_CANSTANDBY;
	mov	r7,#0x02
	C$main.c$491$3$300 ==.
;	main.c:491: if (axradio_cansleep()
	push	ar7
	lcall	_axradio_cansleep
	mov	a,dpl
	pop	ar7
	jz	00157$
	C$main.c$493$3$300 ==.
;	main.c:493: && dbglink_txidle()
	lcall	_dbglink_txidle
	mov	a,dpl
	jz	00157$
	C$main.c$496$3$300 ==.
;	main.c:496: flg |= WTFLAG_CANSLEEP;
	mov	r7,#0x03
00157$:
	C$main.c$498$3$300 ==.
;	main.c:498: wtimer_idle(flg);
	mov	dpl,r7
	lcall	_wtimer_idle
	sjmp	00163$
	C$main.c$501$1$276 ==.
