M:misc
F:G$lcd2_display_radio_error$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$com0_display_radio_error$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$dbglink_display_radio_error$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:Fmisc$delayms_callback$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$delay_ms$0$0({2}DF,SV:S),Z,0,4,0,0,0
S:Lmisc.delay_ms$ms$1$252({2}SI:U),R,0,0,[r6,r7]
S:Lmisc.delay_ms$x$1$253({4}SL:U),B,1,1
...
T:Fmisc$errtbl[({0}S:S$errcode$0$0({1}SC:U),Z,0,0)({1}S:S$msg$0$0({2}DC,SC:U),Z,0,0)]
...
S:Lmisc.lcd2_display_radio_error$err$1$238({1}SC:U),R,0,0,[r7]
S:Lmisc.lcd2_display_radio_error$p$1$239({2}DC,STerrtbl:S),R,0,0,[r5,r6]
S:Lmisc.com0_display_radio_error$err$1$242({1}SC:U),R,0,0,[r7]
S:Lmisc.com0_display_radio_error$p$1$243({2}DC,STerrtbl:S),R,0,0,[r5,r6]
S:Lmisc.dbglink_display_radio_error$err$1$246({1}SC:U),R,0,0,[r7]
S:Lmisc.dbglink_display_radio_error$p$1$247({2}DC,STerrtbl:S),R,0,0,[]
...
S:Fmisc$flash_deviceid$0$0({6}DA6d,SC:U),F,0,0
S:Fmisc$flash_calsector$0$0({31}STcalsector:S),F,0,0
...
S:Fmisc$errtbl$0$0({24}DA8d,STerrtbl:S),D,0,0
S:Fmisc$__str_0$0$0({17}DA17d,SC:S),Z,0,0
S:Fmisc$__str_1$0$0({8}DA8d,SC:S),Z,0,0
S:Fmisc$__str_2$0$0({11}DA11d,SC:S),Z,0,0
S:Fmisc$__str_3$0$0({11}DA11d,SC:S),Z,0,0
S:Fmisc$__str_4$0$0({17}DA17d,SC:S),Z,0,0
S:Fmisc$__str_5$0$0({11}DA11d,SC:S),Z,0,0
S:Fmisc$__str_6$0$0({13}DA13d,SC:S),Z,0,0
