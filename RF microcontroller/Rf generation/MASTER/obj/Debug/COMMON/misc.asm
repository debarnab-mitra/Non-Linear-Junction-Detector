...
_XTALREADY	=	0x7f1a
Fmisc$flash_deviceid$0$0 == 0xfc06
_flash_deviceid	=	0xfc06
Fmisc$flash_calsector$0$0 == 0xfc00
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'lcd2_display_radio_error'
;------------------------------------------------------------
;err                       Allocated to registers r7 
;p                         Allocated to registers r5 r6 
;------------------------------------------------------------
	G$lcd2_display_radio_error$0$0 ==.
	C$misc.c$60$0$0 ==.
;	..\COMMON\misc.c:60: void lcd2_display_radio_error(uint8_t err)
;	-----------------------------------------
;	 function lcd2_display_radio_error
;	-----------------------------------------
_lcd2_display_radio_error:
	ar7 = 0x07
	ar6 = 0x06
	ar5 = 0x05
	ar4 = 0x04
	...
	mov	r7,dpl
	C$misc.c$62$1$0 ==.
;	..\COMMON\misc.c:62: const struct errtbl __code *p = errtbl;
	mov	r5,#_errtbl
	mov	r6,#(_errtbl >> 8)
	C$misc.c$63$1$239 ==.
;	..\COMMON\misc.c:63: do {
...
00103$:
	C$misc.c$64$2$240 ==.
;	..\COMMON\misc.c:64: if (p->errcode == err) {
	mov	dpl,r3
	mov	dph,r4
	clr	a
	movc	a,@a+dptr
	...
	cjne	a,ar7,00102$
	C$misc.c$65$3$241 ==.
;	..\COMMON\misc.c:65: lcd2_setpos(0);
	mov	dpl,#0x00
	push	ar6
	push	ar5
	lcall	_lcd2_setpos
	...
	pop	ar6
	C$misc.c$66$3$241 ==.
;	..\COMMON\misc.c:66: lcd2_writestr(p->msg);
	mov	dpl,r5
	mov	dph,r6
	inc	dptr
	clr	a
...
;	..\COMMON\misc.c:69: ++p;
	...
	mov	ar6,r4
	C$misc.c$70$1$239 ==.
;	..\COMMON\misc.c:70: } while (p->errcode != AXRADIO_ERR_NOERROR);
	mov	dpl,r3
	mov	dph,r4
	clr	a
	movc	a,@a+dptr
...
00106$:
	C$misc.c$71$1$239 ==.
	XG$lcd2_display_radio_error$0$0 ==.
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'com0_display_radio_error'
;------------------------------------------------------------
;err                       Allocated to registers r7 
;p                         Allocated to registers r5 r6 
;------------------------------------------------------------
	G$com0_display_radio_error$0$0 ==.
	C$misc.c$73$1$239 ==.
;	..\COMMON\misc.c:73: void com0_display_radio_error(uint8_t err)
;	-----------------------------------------
;	 function com0_display_radio_error
;	-----------------------------------------
_com0_display_radio_error:
	mov	r7,dpl
	C$misc.c$75$1$239 ==.
;	..\COMMON\misc.c:75: const struct errtbl __code *p = errtbl;
	mov	r5,#_errtbl
	mov	r6,#(_errtbl >> 8)
	C$misc.c$76$1$243 ==.
;	..\COMMON\misc.c:76: do {
...
00103$:
	C$misc.c$77$2$244 ==.
;	..\COMMON\misc.c:77: if (p->errcode == err) {
	mov	dpl,r3
	mov	dph,r4
	clr	a
	movc	a,@a+dptr
	...
	cjne	a,ar7,00102$
	C$misc.c$78$3$245 ==.
;	..\COMMON\misc.c:78: com0_setpos(0);
	mov	dpl,#0x00
	push	ar6
	push	ar5
	lcall	_com0_setpos
	...
	pop	ar6
	C$misc.c$79$3$245 ==.
;	..\COMMON\misc.c:79: com0_writestr(p->msg);
	mov	dpl,r5
	mov	dph,r6
	inc	dptr
	clr	a
...
;	..\COMMON\misc.c:82: ++p;
	...
	mov	ar6,r4
	C$misc.c$83$1$243 ==.
;	..\COMMON\misc.c:83: } while (p->errcode != AXRADIO_ERR_NOERROR);
	mov	dpl,r3
	mov	dph,r4
	clr	a
	movc	a,@a+dptr
...
00106$:
	C$misc.c$84$1$243 ==.
	XG$com0_display_radio_error$0$0 ==.
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'dbglink_display_radio_error'
;------------------------------------------------------------
;err                       Allocated to registers r7 
;p                         Allocated to registers 
;------------------------------------------------------------
	G$dbglink_display_radio_error$0$0 ==.
	C$misc.c$86$1$243 ==.
;	..\COMMON\misc.c:86: void dbglink_display_radio_error(uint8_t err)
;	-----------------------------------------
;	 function dbglink_display_radio_error
;	-----------------------------------------
_dbglink_display_radio_error:
	mov	r7,dpl
	C$misc.c$88$1$243 ==.
;	..\COMMON\misc.c:88: const struct errtbl __code *p = errtbl;
	C$misc.c$89$1$247 ==.
;	..\COMMON\misc.c:89: if (!(DBGLNKSTAT & 0x10))
	mov	a,_DBGLNKSTAT
	jb	acc.4,00112$
	C$misc.c$90$1$247 ==.
;	..\COMMON\misc.c:90: return;
	C$misc.c$91$1$247 ==.
;	..\COMMON\misc.c:91: do {
	sjmp	00108$
00112$:
...
00105$:
	C$misc.c$92$2$248 ==.
;	..\COMMON\misc.c:92: if (p->errcode == err) {
	mov	dpl,r5
	mov	dph,r6
	clr	a
	movc	a,@a+dptr
	...
	cjne	a,ar7,00104$
	C$misc.c$93$3$249 ==.
;	..\COMMON\misc.c:93: dbglink_writestr(p->msg);
	mov	dpl,r5
	mov	dph,r6
	inc	dptr
	clr	a
...
;	..\COMMON\misc.c:96: ++p;
	...
	mov	r6,a
	C$misc.c$97$1$247 ==.
;	..\COMMON\misc.c:97: } while (p->errcode != AXRADIO_ERR_NOERROR);
	mov	dpl,r5
	mov	dph,r6
	clr	a
	movc	a,@a+dptr
...
00108$:
	C$misc.c$98$1$247 ==.
	XG$dbglink_display_radio_error$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	...
	C$misc.c$103$1$247 ==.
;	..\COMMON\misc.c:103: static void delayms_callback(struct wtimer_desc __xdata *desc)
;	-----------------------------------------
;	 function delayms_callback
;	-----------------------------------------
_delayms_callback:
	C$misc.c$106$1$251 ==.
;	..\COMMON\misc.c:106: delaymstimer.handler = 0;
...
;------------------------------------------------------------
	G$delay_ms$0$0 ==.
	C$misc.c$109$1$251 ==.
;	..\COMMON\misc.c:109: __reentrantb void delay_ms(uint16_t ms) __reentrant
;	-----------------------------------------
;	 function delay_ms
;	-----------------------------------------
_delay_ms:
	...
	mov	r7,dph
	C$misc.c$113$1$253 ==.
;	..\COMMON\misc.c:113: wtimer_remove(&delaymstimer);
...
;	..\COMMON\misc.c:114: x = ms;
	...
	mov	@r0,#0x00
	C$misc.c$115$1$253 ==.
;	..\COMMON\misc.c:115: delaymstimer.time = ms >> 1;
	mov	a,r7
	clr	c
	rrc	a
	xch	a,r6
...
;	..\COMMON\misc.c:116: x <<= 3;
	...
	mov	@r0,a
	C$misc.c$117$1$253 ==.
;	..\COMMON\misc.c:117: delaymstimer.time -= x;
	mov	r0,_bp
	inc	r0
	mov	a,r4
	clr	c
...
;	..\COMMON\misc.c:118: x <<= 3;
	...
	mov	@r0,a
	C$misc.c$119$1$253 ==.
;	..\COMMON\misc.c:119: delaymstimer.time += x;
	mov	r0,_bp
	inc	r0
	mov	a,@r0
	add	a,r4
...
;	..\COMMON\misc.c:120: x <<= 2;
	...
	mov	@r0,a
	C$misc.c$121$1$253 ==.
;	..\COMMON\misc.c:121: delaymstimer.time += x;
	mov	r0,_bp
	inc	r0
	mov	a,@r0
	add	a,r4
	...
	movx	@dptr,a
	C$misc.c$122$1$253 ==.
;	..\COMMON\misc.c:122: delaymstimer.handler = delayms_callback;
	mov	dptr,#(_delaymstimer + 0x0002)
	...
	movx	@dptr,a
	C$misc.c$123$1$253 ==.
;	..\COMMON\misc.c:123: wtimer1_addrelative(&delaymstimer);
	mov	dptr,#_delaymstimer
	lcall	_wtimer1_addrelative
	C$misc.c$124$1$253 ==.
;	..\COMMON\misc.c:124: wtimer_runcallbacks();
	lcall	_wtimer_runcallbacks
	C$misc.c$125$1$253 ==.
;	..\COMMON\misc.c:125: do {
00101$:
	C$misc.c$126$2$254 ==.
;	..\COMMON\misc.c:126: wtimer_idle(WTFLAG_CANSTANDBY);
	mov	dpl,#0x02
	lcall	_wtimer_idle
	C$misc.c$127$2$254 ==.
;	..\COMMON\misc.c:127: wtimer_runcallbacks();
	lcall	_wtimer_runcallbacks
	C$misc.c$128$1$253 ==.
;	..\COMMON\misc.c:128: } while (delaymstimer.handler);
	mov	dptr,#(_delaymstimer + 0x0002)
	movx	a,@dptr
	mov	r6,a
	inc	dptr
