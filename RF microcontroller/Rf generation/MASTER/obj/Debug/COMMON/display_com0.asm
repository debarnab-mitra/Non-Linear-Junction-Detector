...
;--------------------------------------------------------
	.area XSEG    (XDATA)
Fdisplay_com0$flash_deviceid$0$0 == 0xfc06
_flash_deviceid	=	0xfc06
Fdisplay_com0$flash_calsector$0$0 == 0xfc00
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'com0_portinit'
;------------------------------------------------------------
	G$com0_portinit$0$0 ==.
	C$display_com0.c$27$0$0 ==.
;	..\COMMON\display_com0.c:27: __reentrantb void com0_portinit(void) __reentrant
;	-----------------------------------------
...
_com0_portinit:
	...
	ar1 = 0x01
	ar0 = 0x00
	C$display_com0.c$29$1$192 ==.
;	..\COMMON\display_com0.c:29: PALTB |= 0x11;
	mov	dptr,#_PALTB
	movx	a,@dptr
	mov	r7,a
	mov	a,#0x11
	orl	a,r7
	movx	@dptr,a
	C$display_com0.c$30$1$192 ==.
;	..\COMMON\display_com0.c:30: DIRB |= (1<<0) | (1<<4);
	orl	_DIRB,#0x11
	C$display_com0.c$31$1$192 ==.
;	..\COMMON\display_com0.c:31: DIRB &= (uint8_t)~(1<<5);
	anl	_DIRB,#0xdf
	C$display_com0.c$32$1$192 ==.
;	..\COMMON\display_com0.c:32: PINSEL &= (uint8_t)~((1<<0) | (1<<1));
	mov	dptr,#_PINSEL
	movx	a,@dptr
	mov	r7,a
	mov	a,#0xfc
	anl	a,r7
	movx	@dptr,a
	C$display_com0.c$34$1$192 ==.
;	..\COMMON\display_com0.c:34: uart_timer0_baud(CLKSRC_SYSCLK, 115200, 20000000UL);
	clr	a
	push	acc
	mov	a,#0x2d
	push	acc
	...
	add	a,#0xf8
	mov	sp,a
	C$display_com0.c$35$1$192 ==.
;	..\COMMON\display_com0.c:35: uart0_init(0, 8, 1);
	mov	_uart0_init_PARM_2,#0x08
	mov	_uart0_init_PARM_3,#0x01
	mov	dpl,#0x00
	lcall	_uart0_init
	C$display_com0.c$36$1$192 ==.
	XG$com0_portinit$0$0 ==.
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'com0_init'
;------------------------------------------------------------
	G$com0_init$0$0 ==.
	C$display_com0.c$38$1$192 ==.
;	..\COMMON\display_com0.c:38: __reentrantb void com0_init(void) __reentrant
;	-----------------------------------------
;	 function com0_init
;	-----------------------------------------
_com0_init:
	C$display_com0.c$40$1$194 ==.
;	..\COMMON\display_com0.c:40: uart_timer0_baud(CLKSRC_SYSCLK, 115200, 20000000UL);
	clr	a
	push	acc
	mov	a,#0x2d
	push	acc
	...
	add	a,#0xf8
	mov	sp,a
	C$display_com0.c$41$1$194 ==.
;	..\COMMON\display_com0.c:41: uart0_init(0, 8, 1);
	mov	_uart0_init_PARM_2,#0x08
	mov	_uart0_init_PARM_3,#0x01
	mov	dpl,#0x00
	lcall	_uart0_init
	C$display_com0.c$43$1$194 ==.
;	..\COMMON\display_com0.c:43: com0_writestr(lcd_border);
	mov	dptr,#_lcd_border
	mov	b,#0x80
	lcall	_com0_writestr
	C$display_com0.c$44$1$194 ==.
;	..\COMMON\display_com0.c:44: com0_setpos(0);
	mov	dpl,#0x00
	lcall	_com0_setpos
	C$display_com0.c$45$1$194 ==.
	XG$com0_init$0$0 ==.
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'com0_writestr2'
;------------------------------------------------------------
;msg                       Allocated to registers r5 r6 r7 
;------------------------------------------------------------
	G$com0_writestr2$0$0 ==.
	C$display_com0.c$47$1$194 ==.
;	..\COMMON\display_com0.c:47: __reentrantb void com0_writestr2(const char* msg)  __reentrant
;	-----------------------------------------
;	 function com0_writestr2
;	-----------------------------------------
_com0_writestr2:
	C$display_com0.c$49$1$196 ==.
;	..\COMMON\display_com0.c:49: uart0_writestr(msg);
	lcall	_uart0_writestr
	C$display_com0.c$50$1$196 ==.
	XG$com0_writestr2$0$0 ==.
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'com0_setrowcol'
;------------------------------------------------------------
	Fdisplay_com0$com0_setrowcol$0$0 ==.
	C$display_com0.c$52$1$196 ==.
;	..\COMMON\display_com0.c:52: static __reentrantb void com0_setrowcol(void) __reentrant
;	-----------------------------------------
;	 function com0_setrowcol
;	-----------------------------------------
_com0_setrowcol:
	C$display_com0.c$54$1$198 ==.
;	..\COMMON\display_com0.c:54: uart0_tx(0x1b);
	mov	dpl,#0x1b
	lcall	_uart0_tx
	C$display_com0.c$55$1$198 ==.
;	..\COMMON\display_com0.c:55: uart0_tx('[');
	mov	dpl,#0x5b
	lcall	_uart0_tx
	C$display_com0.c$56$1$198 ==.
;	..\COMMON\display_com0.c:56: uart0_tx(row + '0');
	mov	dptr,#_row
	movx	a,@dptr
	add	a,#0x30
	mov	dpl,a
	lcall	_uart0_tx
	C$display_com0.c$57$1$198 ==.
;	..\COMMON\display_com0.c:57: uart0_tx(';');
	mov	dpl,#0x3b
	lcall	_uart0_tx
	C$display_com0.c$58$1$198 ==.
;	..\COMMON\display_com0.c:58: uart0_tx(column / 10 + '0');
	mov	dptr,#_column
	movx	a,@dptr
	mov	b,#0x0a
	div	ab
	...
	mov	dpl,a
	lcall	_uart0_tx
	C$display_com0.c$59$1$198 ==.
;	..\COMMON\display_com0.c:59: uart0_tx(column % 10 + '0');
	mov	dptr,#_column
	movx	a,@dptr
	mov	b,#0x0a
	div	ab
	...
	mov	dpl,a
	lcall	_uart0_tx
	C$display_com0.c$60$1$198 ==.
;	..\COMMON\display_com0.c:60: uart0_tx('f');
	mov	dpl,#0x66
	lcall	_uart0_tx
	C$display_com0.c$61$1$198 ==.
	XFdisplay_com0$com0_setrowcol$0$0 ==.
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'com0_newline'
;------------------------------------------------------------
	G$com0_newline$0$0 ==.
	C$display_com0.c$63$1$198 ==.
;	..\COMMON\display_com0.c:63: __reentrantb void com0_newline(void) __reentrant
;	-----------------------------------------
;	 function com0_newline
;	-----------------------------------------
_com0_newline:
	C$display_com0.c$65$1$200 ==.
;	..\COMMON\display_com0.c:65: if (row < 3)
	mov	dptr,#_row
	movx	a,@dptr
	mov	r7,a
	cjne	r7,#0x03,00108$
00108$:
	jnc	00102$
	C$display_com0.c$66$1$200 ==.
;	..\COMMON\display_com0.c:66: ++row;
	mov	dptr,#_row
	mov	a,r7
	inc	a
	movx	@dptr,a
00102$:
	C$display_com0.c$67$1$200 ==.
;	..\COMMON\display_com0.c:67: column = 2;
	mov	dptr,#_column
	mov	a,#0x02
	movx	@dptr,a
	C$display_com0.c$68$1$200 ==.
;	..\COMMON\display_com0.c:68: com0_setrowcol();
	lcall	_com0_setrowcol
	C$display_com0.c$69$1$200 ==.
	XG$com0_newline$0$0 ==.
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'com0_setpos'
;------------------------------------------------------------
;v                         Allocated to registers r7 
;------------------------------------------------------------
	G$com0_setpos$0$0 ==.
	C$display_com0.c$71$1$200 ==.
;	..\COMMON\display_com0.c:71: __reentrantb void com0_setpos(uint8_t v) __reentrant
;	-----------------------------------------
;	 function com0_setpos
;	-----------------------------------------
_com0_setpos:
	C$display_com0.c$75$1$202 ==.
;	..\COMMON\display_com0.c:75: row = (v >> 6) + 2;
	mov	a,dpl
	mov	r7,a
	rl	a
	rl	a
	...
	add	a,r6
	movx	@dptr,a
	C$display_com0.c$76$1$202 ==.
;	..\COMMON\display_com0.c:76: column = (v & 0x3F) + 2;
	mov	a,#0x3f
	anl	a,r7
	mov	dptr,#_column
	add	a,#0x02
	movx	@dptr,a
	C$display_com0.c$77$1$202 ==.
;	..\COMMON\display_com0.c:77: com0_setrowcol();
	lcall	_com0_setrowcol
	C$display_com0.c$78$1$202 ==.
	XG$com0_setpos$0$0 ==.
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'com0_writestr'
;------------------------------------------------------------
;msg                       Allocated to registers 
;ch                        Allocated to registers r3 
;------------------------------------------------------------
	G$com0_writestr$0$0 ==.
	C$display_com0.c$80$1$202 ==.
;	..\COMMON\display_com0.c:80: __reentrantb void com0_writestr(const char __generic *msg) __reentrant
;	-----------------------------------------
...
_com0_writestr:
	...
	mov	r7,b
00104$:
	C$display_com0.c$83$2$205 ==.
;	..\COMMON\display_com0.c:83: char ch = *msg;
	mov	dpl,r5
	mov	dph,r6
	mov	b,r7
	lcall	__gptrget
	C$display_com0.c$84$2$205 ==.
;	..\COMMON\display_com0.c:84: if (!ch)
	mov	r4,a
	mov	r3,a
	jz	00106$
	C$display_com0.c$86$2$205 ==.
;	..\COMMON\display_com0.c:86: com0_tx(ch);
	mov	dpl,r3
	push	ar7
	push	ar6
	push	ar5
	...
	pop	ar6
	pop	ar7
	C$display_com0.c$87$2$205 ==.
;	..\COMMON\display_com0.c:87: msg++;
	inc	r5
	cjne	r5,#0x00,00104$
	inc	r6
	sjmp	00104$
00106$:
	C$display_com0.c$90$1$204 ==.
	XG$com0_writestr$0$0 ==.
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'com0_tx'
;------------------------------------------------------------
;val                       Allocated to registers r7 
;------------------------------------------------------------
	G$com0_tx$0$0 ==.
	C$display_com0.c$92$1$204 ==.
;	..\COMMON\display_com0.c:92: __reentrantb void com0_tx(uint8_t val)  __reentrant
;	-----------------------------------------
;	 function com0_tx
;	-----------------------------------------
_com0_tx:
	mov	r7,dpl
	C$display_com0.c$94$1$207 ==.
;	..\COMMON\display_com0.c:94: if (val == '\n')
	cjne	r7,#0x0a,00102$
	C$display_com0.c$95$1$207 ==.
;	..\COMMON\display_com0.c:95: com0_newline();
	lcall	_com0_newline
	sjmp	00104$
00102$:
	C$display_com0.c$97$1$207 ==.
;	..\COMMON\display_com0.c:97: uart0_tx(val);
	mov	dpl,r7
	lcall	_uart0_tx
00104$:
	C$display_com0.c$98$1$207 ==.
	XG$com0_tx$0$0 ==.
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'com0_clear'
;------------------------------------------------------------
;len                       Allocated to stack - _bp -3
;pos                       Allocated to registers r7 
;------------------------------------------------------------
	G$com0_clear$0$0 ==.
	C$display_com0.c$100$1$207 ==.
;	..\COMMON\display_com0.c:100: __reentrantb void com0_clear(uint8_t pos, uint8_t len) __reentrant
;	-----------------------------------------
;	 function com0_clear
;	-----------------------------------------
_com0_clear:
	push	_bp
	mov	_bp,sp
	C$display_com0.c$102$1$209 ==.
;	..\COMMON\display_com0.c:102: com0_setpos(pos);
	lcall	_com0_setpos
	C$display_com0.c$103$1$209 ==.
;	..\COMMON\display_com0.c:103: if (!len)
	mov	a,_bp
	add	a,#0xfd
	mov	r0,a
	mov	a,@r0
	jnz	00109$
	C$display_com0.c$104$1$209 ==.
;	..\COMMON\display_com0.c:104: return;
	C$display_com0.c$105$1$209 ==.
;	..\COMMON\display_com0.c:105: do {
	sjmp	00106$
00109$:
	mov	a,_bp
	add	a,#0xfd
	...
	mov	ar7,@r0
00103$:
	C$display_com0.c$106$2$210 ==.
;	..\COMMON\display_com0.c:106: com0_tx(' ');
	mov	dpl,#0x20
	push	ar7
	lcall	_com0_tx
	pop	ar7
	C$display_com0.c$107$1$209 ==.
;	..\COMMON\display_com0.c:107: } while (--len);
	djnz	r7,00103$
00106$:
	pop	_bp
	C$display_com0.c$108$1$209 ==.
	XG$com0_clear$0$0 ==.
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
Fdisplay_com0$lcd_border$0$0 == .
_lcd_border:
	.db 0x1b
	.ascii "[0;8;44;30m"
	.db 0x1b
