...
S:Lconfig.axradio_byteconv$b$1$126({1}SC:U),R,0,0,[r7]
F:G$axradio_byteconv_buffer$0$0({2}DF,SV:S),C,0,0,0,0,0
S:Lconfig.axradio_byteconv_buffer$buflen$1$128({2}SI:U),B,1,-4
S:Lconfig.axradio_byteconv_buffer$buf$1$128({2}DX,SC:U),R,0,0,[]
F:G$axradio_framing_check_crc$0$0({2}DF,SI:U),Z,0,0,0,0,0
S:Lconfig.axradio_framing_check_crc$cnt$1$130({2}SI:U),B,1,-4
S:Lconfig.axradio_framing_check_crc$pkt$1$130({2}DX,SC:U),R,0,0,[r6,r7]
F:G$axradio_framing_append_crc$0$0({2}DF,SI:U),Z,0,0,0,0,0
S:Lconfig.axradio_framing_append_crc$cnt$1$132({2}SI:U),B,1,-4
S:Lconfig.axradio_framing_append_crc$pkt$1$132({2}DX,SC:U),R,0,0,[r6,r7]
S:Lconfig.axradio_framing_append_crc$s$1$133({2}SI:U),R,0,0,[r4,r5]
T:Fconfig$axradio_status_receive[({0}S:S$phy$0$0({10}STaxradio_status_receive_phy:S),Z,0,0)({10}S:S$mac$0$0({10}STaxradio_status_receive_mac:S),Z,0,0)({20}S:S$pktdata$0$0({2}DX,SC:U),Z,0,0)({22}S:S$pktlen$0$0({2}SI:U),Z,0,0)]
T:Fconfig$axradio_address[({0}S:S$addr$0$0({4}DA4d,SC:U),Z,0,0)]
T:Fconfig$axradio_address_mask[({0}S:S$addr$0$0({4}DA4d,SC:U),Z,0,0)({4}S:S$mask$0$0({4}DA4d,SC:U),Z,0,0)]
T:Fconfig$__00000000[({0}S:S$rx$0$0({24}STaxradio_status_receive:S),Z,0,0)({0}S:S$cs$0$0({3}STaxradio_status_channelstate:S),Z,0,0)]
T:Fconfig$axradio_status_channelstate[({0}S:S$rssi$0$0({2}SI:S),Z,0,0)({2}S:S$busy$0$0({1}SC:U),Z,0,0)]
T:Fconfig$u32endian[({0}S:S$b0$0$0({1}SC:U),Z,0,0)({1}S:S$b1$0$0({1}SC:U),Z,0,0)({2}S:S$b2$0$0({1}SC:U),Z,0,0)({3}S:S$b3$0$0({1}SC:U),Z,0,0)]
T:Fconfig$u16endian[({0}S:S$b0$0$0({1}SC:U),Z,0,0)({1}S:S$b1$0$0({1}SC:U),Z,0,0)]
T:Fconfig$axradio_status_receive_mac[({0}S:S$remoteaddr$0$0({4}DA4d,SC:U),Z,0,0)({4}S:S$localaddr$0$0({4}DA4d,SC:U),Z,0,0)({8}S:S$raw$0$0({2}DX,SC:U),Z,0,0)]
...
T:Fconfig$axradio_status[({0}S:S$status$0$0({1}SC:U),Z,0,0)({1}S:S$error$0$0({1}SC:U),Z,0,0)({2}S:S$time$0$0({4}SL:U),Z,0,0)({6}S:S$u$0$0({24}ST__00000000:S),Z,0,0)]
...
S:Lconfig.axradio_conv_freq_fromhz$f$1$118({4}SL:S),R,0,0,[]
S:Lconfig.axradio_conv_freq_tohz$f$1$120({4}SL:S),R,0,0,[]
S:Lconfig.axradio_conv_freq_fromreg$f$1$122({4}SL:S),R,0,0,[]
S:Lconfig.axradio_conv_timeinterval_totimer0$dt$1$124({4}SL:S),R,0,0,[r4,r5,r6,r7]
S:Lconfig.axradio_conv_timeinterval_totimer0$r$1$125({4}SL:S),R,0,0,[r0,r1,r2,r3]
...
S:G$axradio_phy_chanpllrng$0$0({1}DA1d,SC:U),F,0,0
...
S:G$axradio_phy_chanpllrnginit$0$0({1}DA1d,SC:U),D,0,0
