...
;------------------------------------------------------------
	...
	C$config.c$11$0$0 ==.
;	..\AX_Radio_Lab_output\config.c:11: __reentrantb void ax5043_set_registers(void) __reentrant
;	-----------------------------------------
...
_ax5043_set_registers:
	...
	ar0 = 0x00
	C$config.c$13$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:13: AX5043_MODULATION              = 0x08;
	mov	dptr,#_AX5043_MODULATION
	mov	a,#0x08
	movx	@dptr,a
	C$config.c$14$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:14: AX5043_ENCODING                = 0x00;
	mov	dptr,#_AX5043_ENCODING
	clr	a
	movx	@dptr,a
	C$config.c$15$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:15: AX5043_FRAMING                 = 0x26;
	mov	dptr,#_AX5043_FRAMING
	mov	a,#0x26
	movx	@dptr,a
	C$config.c$16$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:16: AX5043_PINFUNCSYSCLK           = 0x01;
	mov	dptr,#_AX5043_PINFUNCSYSCLK
	mov	a,#0x01
	movx	@dptr,a
	C$config.c$17$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:17: AX5043_PINFUNCDCLK             = 0x01;
	mov	dptr,#_AX5043_PINFUNCDCLK
	movx	@dptr,a
	C$config.c$18$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:18: AX5043_PINFUNCDATA             = 0x01;
	mov	dptr,#_AX5043_PINFUNCDATA
	movx	@dptr,a
	C$config.c$19$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:19: AX5043_PINFUNCANTSEL           = 0x82;
	mov	dptr,#_AX5043_PINFUNCANTSEL
	mov	a,#0x82
	movx	@dptr,a
	C$config.c$20$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:20: AX5043_PINFUNCPWRAMP           = 0x82;
	mov	dptr,#_AX5043_PINFUNCPWRAMP
	movx	@dptr,a
	C$config.c$21$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:21: AX5043_WAKEUPXOEARLY           = 0x01;
	mov	dptr,#_AX5043_WAKEUPXOEARLY
	mov	a,#0x01
	movx	@dptr,a
	C$config.c$22$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:22: AX5043_IFFREQ1                 = 0x0B;
	mov	dptr,#_AX5043_IFFREQ1
	mov	a,#0x0b
	movx	@dptr,a
	C$config.c$23$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:23: AX5043_IFFREQ0                 = 0x09;
	mov	dptr,#_AX5043_IFFREQ0
	mov	a,#0x09
	movx	@dptr,a
	C$config.c$24$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:24: AX5043_DECIMATION              = 0x02;
	mov	dptr,#_AX5043_DECIMATION
	mov	a,#0x02
	movx	@dptr,a
	C$config.c$25$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:25: AX5043_RXDATARATE2             = 0x00;
	mov	dptr,#_AX5043_RXDATARATE2
	clr	a
	movx	@dptr,a
	C$config.c$26$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:26: AX5043_RXDATARATE1             = 0x3C;
	mov	dptr,#_AX5043_RXDATARATE1
	mov	a,#0x3c
	movx	@dptr,a
	C$config.c$27$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:27: AX5043_RXDATARATE0             = 0x00;
	mov	dptr,#_AX5043_RXDATARATE0
	clr	a
	movx	@dptr,a
	C$config.c$28$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:28: AX5043_MAXDROFFSET2            = 0x00;
	mov	dptr,#_AX5043_MAXDROFFSET2
	movx	@dptr,a
	C$config.c$29$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:29: AX5043_MAXDROFFSET1            = 0x00;
	mov	dptr,#_AX5043_MAXDROFFSET1
	movx	@dptr,a
	C$config.c$30$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:30: AX5043_MAXDROFFSET0            = 0x00;
	mov	dptr,#_AX5043_MAXDROFFSET0
	movx	@dptr,a
	C$config.c$31$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:31: AX5043_MAXRFOFFSET2            = 0x80;
	mov	dptr,#_AX5043_MAXRFOFFSET2
	mov	a,#0x80
	movx	@dptr,a
	C$config.c$32$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:32: AX5043_MAXRFOFFSET1            = 0x17;
	mov	dptr,#_AX5043_MAXRFOFFSET1
	mov	a,#0x17
	movx	@dptr,a
	C$config.c$33$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:33: AX5043_MAXRFOFFSET0            = 0xB6;
	mov	dptr,#_AX5043_MAXRFOFFSET0
	mov	a,#0xb6
	movx	@dptr,a
	C$config.c$34$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:34: AX5043_FSKDMAX1                = 0x00;
	mov	dptr,#_AX5043_FSKDMAX1
	clr	a
	movx	@dptr,a
	C$config.c$35$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:35: AX5043_FSKDMAX0                = 0xA6;
	mov	dptr,#_AX5043_FSKDMAX0
	mov	a,#0xa6
	movx	@dptr,a
	C$config.c$36$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:36: AX5043_FSKDMIN1                = 0xFF;
	mov	dptr,#_AX5043_FSKDMIN1
	mov	a,#0xff
	movx	@dptr,a
	C$config.c$37$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:37: AX5043_FSKDMIN0                = 0x5A;
	mov	dptr,#_AX5043_FSKDMIN0
	mov	a,#0x5a
	movx	@dptr,a
	C$config.c$38$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:38: AX5043_AMPLFILTER              = 0x00;
	mov	dptr,#_AX5043_AMPLFILTER
	clr	a
	movx	@dptr,a
	C$config.c$39$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:39: AX5043_RXPARAMSETS             = 0xF4;
	mov	dptr,#_AX5043_RXPARAMSETS
	mov	a,#0xf4
	movx	@dptr,a
	C$config.c$40$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:40: AX5043_AGCGAIN0                = 0x83;
	mov	dptr,#_AX5043_AGCGAIN0
	mov	a,#0x83
	movx	@dptr,a
	C$config.c$41$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:41: AX5043_AGCTARGET0              = 0x84;
	mov	dptr,#_AX5043_AGCTARGET0
	inc	a
	movx	@dptr,a
	C$config.c$42$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:42: AX5043_TIMEGAIN0               = 0xF8;
	mov	dptr,#_AX5043_TIMEGAIN0
	mov	a,#0xf8
	movx	@dptr,a
	C$config.c$43$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:43: AX5043_DRGAIN0                 = 0xF2;
	mov	dptr,#_AX5043_DRGAIN0
	mov	a,#0xf2
	movx	@dptr,a
	C$config.c$44$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:44: AX5043_PHASEGAIN0              = 0xC3;
	mov	dptr,#_AX5043_PHASEGAIN0
	mov	a,#0xc3
	movx	@dptr,a
	C$config.c$45$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:45: AX5043_FREQUENCYGAINA0         = 0x0F;
	mov	dptr,#_AX5043_FREQUENCYGAINA0
	mov	a,#0x0f
	movx	@dptr,a
	C$config.c$46$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:46: AX5043_FREQUENCYGAINB0         = 0x1F;
	mov	dptr,#_AX5043_FREQUENCYGAINB0
	mov	a,#0x1f
	movx	@dptr,a
	C$config.c$47$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:47: AX5043_FREQUENCYGAINC0         = 0x05;
	mov	dptr,#_AX5043_FREQUENCYGAINC0
	mov	a,#0x05
	movx	@dptr,a
	C$config.c$48$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:48: AX5043_FREQUENCYGAIND0         = 0x05;
	mov	dptr,#_AX5043_FREQUENCYGAIND0
	movx	@dptr,a
	C$config.c$49$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:49: AX5043_AMPLITUDEGAIN0          = 0x06;
	mov	dptr,#_AX5043_AMPLITUDEGAIN0
	inc	a
	movx	@dptr,a
	C$config.c$50$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:50: AX5043_FREQDEV10               = 0x00;
	mov	dptr,#_AX5043_FREQDEV10
	clr	a
	movx	@dptr,a
	C$config.c$51$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:51: AX5043_FREQDEV00               = 0x00;
	mov	dptr,#_AX5043_FREQDEV00
	movx	@dptr,a
	C$config.c$52$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:52: AX5043_BBOFFSRES0              = 0x00;
	mov	dptr,#_AX5043_BBOFFSRES0
	movx	@dptr,a
	C$config.c$53$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:53: AX5043_AGCGAIN1                = 0x83;
	mov	dptr,#_AX5043_AGCGAIN1
	mov	a,#0x83
	movx	@dptr,a
	C$config.c$54$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:54: AX5043_AGCTARGET1              = 0x84;
	mov	dptr,#_AX5043_AGCTARGET1
	inc	a
	movx	@dptr,a
	C$config.c$55$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:55: AX5043_AGCAHYST1               = 0x00;
	mov	dptr,#_AX5043_AGCAHYST1
	clr	a
	movx	@dptr,a
	C$config.c$56$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:56: AX5043_AGCMINMAX1              = 0x00;
	mov	dptr,#_AX5043_AGCMINMAX1
	movx	@dptr,a
	C$config.c$57$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:57: AX5043_TIMEGAIN1               = 0xF6;
	mov	dptr,#_AX5043_TIMEGAIN1
	mov	a,#0xf6
	movx	@dptr,a
	C$config.c$58$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:58: AX5043_DRGAIN1                 = 0xF1;
	mov	dptr,#_AX5043_DRGAIN1
	mov	a,#0xf1
	movx	@dptr,a
	C$config.c$59$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:59: AX5043_PHASEGAIN1              = 0xC3;
	mov	dptr,#_AX5043_PHASEGAIN1
	mov	a,#0xc3
	movx	@dptr,a
	C$config.c$60$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:60: AX5043_FREQUENCYGAINA1         = 0x0F;
	mov	dptr,#_AX5043_FREQUENCYGAINA1
	mov	a,#0x0f
	movx	@dptr,a
	C$config.c$61$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:61: AX5043_FREQUENCYGAINB1         = 0x1F;
	mov	dptr,#_AX5043_FREQUENCYGAINB1
	mov	a,#0x1f
	movx	@dptr,a
	C$config.c$62$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:62: AX5043_FREQUENCYGAINC1         = 0x05;
	mov	dptr,#_AX5043_FREQUENCYGAINC1
	mov	a,#0x05
	movx	@dptr,a
	C$config.c$63$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:63: AX5043_FREQUENCYGAIND1         = 0x05;
	mov	dptr,#_AX5043_FREQUENCYGAIND1
	movx	@dptr,a
	C$config.c$64$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:64: AX5043_AMPLITUDEGAIN1          = 0x06;
	mov	dptr,#_AX5043_AMPLITUDEGAIN1
	inc	a
	movx	@dptr,a
	C$config.c$65$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:65: AX5043_FREQDEV11               = 0x00;
	mov	dptr,#_AX5043_FREQDEV11
	clr	a
	movx	@dptr,a
	C$config.c$66$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:66: AX5043_FREQDEV01               = 0x00;
	mov	dptr,#_AX5043_FREQDEV01
	movx	@dptr,a
	C$config.c$67$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:67: AX5043_FOURFSK1                = 0x16;
	mov	dptr,#_AX5043_FOURFSK1
	mov	a,#0x16
	movx	@dptr,a
	C$config.c$68$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:68: AX5043_BBOFFSRES1              = 0x00;
	mov	dptr,#_AX5043_BBOFFSRES1
	clr	a
	movx	@dptr,a
	C$config.c$69$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:69: AX5043_AGCGAIN3                = 0xFF;
	mov	dptr,#_AX5043_AGCGAIN3
	dec	a
	movx	@dptr,a
	C$config.c$70$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:70: AX5043_AGCTARGET3              = 0x84;
	mov	dptr,#_AX5043_AGCTARGET3
	mov	a,#0x84
	movx	@dptr,a
	C$config.c$71$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:71: AX5043_AGCAHYST3               = 0x00;
	mov	dptr,#_AX5043_AGCAHYST3
	clr	a
	movx	@dptr,a
	C$config.c$72$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:72: AX5043_AGCMINMAX3              = 0x00;
	mov	dptr,#_AX5043_AGCMINMAX3
	movx	@dptr,a
	C$config.c$73$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:73: AX5043_TIMEGAIN3               = 0xF5;
	mov	dptr,#_AX5043_TIMEGAIN3
	mov	a,#0xf5
	movx	@dptr,a
	C$config.c$74$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:74: AX5043_DRGAIN3                 = 0xF0;
	mov	dptr,#_AX5043_DRGAIN3
	mov	a,#0xf0
	movx	@dptr,a
	C$config.c$75$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:75: AX5043_PHASEGAIN3              = 0xC3;
	mov	dptr,#_AX5043_PHASEGAIN3
	mov	a,#0xc3
	movx	@dptr,a
	C$config.c$76$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:76: AX5043_FREQUENCYGAINA3         = 0x0F;
	mov	dptr,#_AX5043_FREQUENCYGAINA3
	mov	a,#0x0f
	movx	@dptr,a
	C$config.c$77$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:77: AX5043_FREQUENCYGAINB3         = 0x1F;
	mov	dptr,#_AX5043_FREQUENCYGAINB3
	mov	a,#0x1f
	movx	@dptr,a
	C$config.c$78$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:78: AX5043_FREQUENCYGAINC3         = 0x09;
	mov	dptr,#_AX5043_FREQUENCYGAINC3
	mov	a,#0x09
	movx	@dptr,a
	C$config.c$79$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:79: AX5043_FREQUENCYGAIND3         = 0x09;
	mov	dptr,#_AX5043_FREQUENCYGAIND3
	movx	@dptr,a
	C$config.c$80$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:80: AX5043_AMPLITUDEGAIN3          = 0x06;
	mov	dptr,#_AX5043_AMPLITUDEGAIN3
	mov	a,#0x06
	movx	@dptr,a
	C$config.c$81$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:81: AX5043_FREQDEV13               = 0x00;
	mov	dptr,#_AX5043_FREQDEV13
	clr	a
	movx	@dptr,a
	C$config.c$82$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:82: AX5043_FREQDEV03               = 0x00;
	mov	dptr,#_AX5043_FREQDEV03
	movx	@dptr,a
	C$config.c$83$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:83: AX5043_FOURFSK3                = 0x16;
	mov	dptr,#_AX5043_FOURFSK3
	mov	a,#0x16
	movx	@dptr,a
	C$config.c$84$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:84: AX5043_BBOFFSRES3              = 0x00;
	mov	dptr,#_AX5043_BBOFFSRES3
	clr	a
	movx	@dptr,a
	C$config.c$85$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:85: AX5043_MODCFGF                 = 0x00;
	mov	dptr,#_AX5043_MODCFGF
	movx	@dptr,a
	C$config.c$86$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:86: AX5043_FSKDEV2                 = 0x00;
	mov	dptr,#_AX5043_FSKDEV2
	movx	@dptr,a
	C$config.c$87$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:87: AX5043_FSKDEV1                 = 0x00;
	mov	dptr,#_AX5043_FSKDEV1
	movx	@dptr,a
	C$config.c$88$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:88: AX5043_FSKDEV0                 = 0x00;
	mov	dptr,#_AX5043_FSKDEV0
	movx	@dptr,a
	C$config.c$89$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:89: AX5043_MODCFGA                 = 0x05;
	mov	dptr,#_AX5043_MODCFGA
	mov	a,#0x05
	movx	@dptr,a
	C$config.c$90$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:90: AX5043_TXRATE2                 = 0x00;
	mov	dptr,#_AX5043_TXRATE2
	clr	a
	movx	@dptr,a
	C$config.c$91$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:91: AX5043_TXRATE1                 = 0x88;
	mov	dptr,#_AX5043_TXRATE1
	mov	a,#0x88
	movx	@dptr,a
	C$config.c$92$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:92: AX5043_TXRATE0                 = 0x89;
	mov	dptr,#_AX5043_TXRATE0
	inc	a
	movx	@dptr,a
	C$config.c$93$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:93: AX5043_TXPWRCOEFFB1            = 0x0F;
	mov	dptr,#_AX5043_TXPWRCOEFFB1
	mov	a,#0x0f
	movx	@dptr,a
	C$config.c$94$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:94: AX5043_TXPWRCOEFFB0            = 0xFF;
	mov	dptr,#_AX5043_TXPWRCOEFFB0
	mov	a,#0xff
	movx	@dptr,a
	C$config.c$95$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:95: AX5043_PLLVCOI                 = 0x99;
	mov	dptr,#_AX5043_PLLVCOI
	mov	a,#0x99
	movx	@dptr,a
	C$config.c$96$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:96: AX5043_PLLRNGCLK               = 0x05;
	mov	dptr,#_AX5043_PLLRNGCLK
	mov	a,#0x05
	movx	@dptr,a
	C$config.c$97$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:97: AX5043_BBTUNE                  = 0x03;
	mov	dptr,#_AX5043_BBTUNE
	mov	a,#0x03
	movx	@dptr,a
	C$config.c$98$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:98: AX5043_BBOFFSCAP               = 0x77;
	mov	dptr,#_AX5043_BBOFFSCAP
	mov	a,#0x77
	movx	@dptr,a
	C$config.c$99$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:99: AX5043_PKTADDRCFG              = 0x01;
	mov	dptr,#_AX5043_PKTADDRCFG
	mov	a,#0x01
	movx	@dptr,a
	C$config.c$100$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:100: AX5043_PKTLENCFG               = 0x80;
	mov	dptr,#_AX5043_PKTLENCFG
	rr	a
	movx	@dptr,a
	C$config.c$101$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:101: AX5043_PKTLENOFFSET            = 0x00;
	mov	dptr,#_AX5043_PKTLENOFFSET
	clr	a
	movx	@dptr,a
	C$config.c$102$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:102: AX5043_PKTMAXLEN               = 0xC8;
	mov	dptr,#_AX5043_PKTMAXLEN
	mov	a,#0xc8
	movx	@dptr,a
	C$config.c$103$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:103: AX5043_MATCH0PAT3              = 0xAA;
	mov	dptr,#_AX5043_MATCH0PAT3
	mov	a,#0xaa
	movx	@dptr,a
	C$config.c$104$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:104: AX5043_MATCH0PAT2              = 0xCC;
	mov	dptr,#_AX5043_MATCH0PAT2
	mov	a,#0xcc
	movx	@dptr,a
	C$config.c$105$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:105: AX5043_MATCH0PAT1              = 0xAA;
	mov	dptr,#_AX5043_MATCH0PAT1
	mov	a,#0xaa
	movx	@dptr,a
	C$config.c$106$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:106: AX5043_MATCH0PAT0              = 0xCC;
	mov	dptr,#_AX5043_MATCH0PAT0
	mov	a,#0xcc
	movx	@dptr,a
	C$config.c$107$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:107: AX5043_MATCH0LEN               = 0x1F;
	mov	dptr,#_AX5043_MATCH0LEN
	mov	a,#0x1f
	movx	@dptr,a
	C$config.c$108$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:108: AX5043_MATCH0MAX               = 0x1F;
	mov	dptr,#_AX5043_MATCH0MAX
	movx	@dptr,a
	C$config.c$109$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:109: AX5043_MATCH1PAT1              = 0x55;
	mov	dptr,#_AX5043_MATCH1PAT1
	mov	a,#0x55
	movx	@dptr,a
	C$config.c$110$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:110: AX5043_MATCH1PAT0              = 0x55;
	mov	dptr,#_AX5043_MATCH1PAT0
	movx	@dptr,a
	C$config.c$111$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:111: AX5043_MATCH1LEN               = 0x8A;
	mov	dptr,#_AX5043_MATCH1LEN
	mov	a,#0x8a
	movx	@dptr,a
	C$config.c$112$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:112: AX5043_MATCH1MAX               = 0x0A;
	mov	dptr,#_AX5043_MATCH1MAX
	mov	a,#0x0a
	movx	@dptr,a
	C$config.c$113$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:113: AX5043_TMGTXBOOST              = 0x5B;
	mov	dptr,#_AX5043_TMGTXBOOST
	mov	a,#0x5b
	movx	@dptr,a
	C$config.c$114$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:114: AX5043_TMGTXSETTLE             = 0x3E;
	mov	dptr,#_AX5043_TMGTXSETTLE
	mov	a,#0x3e
	movx	@dptr,a
	C$config.c$115$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:115: AX5043_TMGRXBOOST              = 0x5B;
	mov	dptr,#_AX5043_TMGRXBOOST
	mov	a,#0x5b
	movx	@dptr,a
	C$config.c$116$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:116: AX5043_TMGRXSETTLE             = 0x3E;
	mov	dptr,#_AX5043_TMGRXSETTLE
	mov	a,#0x3e
	movx	@dptr,a
	C$config.c$117$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:117: AX5043_TMGRXOFFSACQ            = 0x00;
	mov	dptr,#_AX5043_TMGRXOFFSACQ
	clr	a
	movx	@dptr,a
	C$config.c$118$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:118: AX5043_TMGRXCOARSEAGC          = 0x9C;
	mov	dptr,#_AX5043_TMGRXCOARSEAGC
	mov	a,#0x9c
	movx	@dptr,a
	C$config.c$119$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:119: AX5043_TMGRXRSSI               = 0x03;
	mov	dptr,#_AX5043_TMGRXRSSI
	mov	a,#0x03
	movx	@dptr,a
	C$config.c$120$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:120: AX5043_TMGRXPREAMBLE2          = 0x35;
	mov	dptr,#_AX5043_TMGRXPREAMBLE2
	mov	a,#0x35
	movx	@dptr,a
	C$config.c$121$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:121: AX5043_RSSIABSTHR              = 0xEB;
	mov	dptr,#_AX5043_RSSIABSTHR
	mov	a,#0xeb
	movx	@dptr,a
	C$config.c$122$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:122: AX5043_BGNDRSSITHR             = 0x00;
	mov	dptr,#_AX5043_BGNDRSSITHR
	clr	a
	movx	@dptr,a
	C$config.c$123$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:123: AX5043_PKTCHUNKSIZE            = 0x0D;
	mov	dptr,#_AX5043_PKTCHUNKSIZE
	mov	a,#0x0d
	movx	@dptr,a
	C$config.c$124$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:124: AX5043_PKTACCEPTFLAGS          = 0x20;
	mov	dptr,#_AX5043_PKTACCEPTFLAGS
	mov	a,#0x20
	movx	@dptr,a
	C$config.c$125$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:125: AX5043_DACVALUE1               = 0x00;
	mov	dptr,#_AX5043_DACVALUE1
	clr	a
	movx	@dptr,a
	C$config.c$126$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:126: AX5043_DACVALUE0               = 0x00;
	mov	dptr,#_AX5043_DACVALUE0
	movx	@dptr,a
	C$config.c$127$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:127: AX5043_DACCONFIG               = 0x00;
	mov	dptr,#_AX5043_DACCONFIG
	movx	@dptr,a
	C$config.c$128$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:128: AX5043_REF                     = 0x03;
	mov	dptr,#_AX5043_REF
	mov	a,#0x03
	movx	@dptr,a
	C$config.c$129$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:129: AX5043_XTALOSC                 = 0x0D;
	mov	dptr,#_AX5043_XTALOSC
	mov	a,#0x0d
	movx	@dptr,a
	C$config.c$130$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:130: AX5043_XTALAMPL                = 0x07;
	mov	dptr,#_AX5043_XTALAMPL
	mov	a,#0x07
	movx	@dptr,a
	C$config.c$131$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:131: AX5043_0xF1C                   = 0x07;
	mov	dptr,#_AX5043_0xF1C
	movx	@dptr,a
	C$config.c$132$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:132: AX5043_0xF21                   = 0x68;
	mov	dptr,#_AX5043_0xF21
	mov	a,#0x68
	movx	@dptr,a
	C$config.c$133$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:133: AX5043_0xF22                   = 0xFF;
	mov	dptr,#_AX5043_0xF22
	mov	a,#0xff
	movx	@dptr,a
	C$config.c$134$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:134: AX5043_0xF23                   = 0x84;
	mov	dptr,#_AX5043_0xF23
	mov	a,#0x84
	movx	@dptr,a
	C$config.c$135$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:135: AX5043_0xF26                   = 0x98;
	mov	dptr,#_AX5043_0xF26
	mov	a,#0x98
	movx	@dptr,a
	C$config.c$136$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:136: AX5043_0xF34                   = 0x08;
	mov	dptr,#_AX5043_0xF34
	mov	a,#0x08
	movx	@dptr,a
	C$config.c$137$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:137: AX5043_0xF35                   = 0x11;
	mov	dptr,#_AX5043_0xF35
	mov	a,#0x11
	movx	@dptr,a
	C$config.c$138$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:138: AX5043_0xF44                   = 0x25;
	mov	dptr,#_AX5043_0xF44
	mov	a,#0x25
	movx	@dptr,a
	C$config.c$139$1$103 ==.
...
;------------------------------------------------------------
	...
	C$config.c$142$1$103 ==.
;	..\AX_Radio_Lab_output\config.c:142: __reentrantb void ax5043_set_registers_tx(void) __reentrant
;	-----------------------------------------
;	 function ax5043_set_registers_tx
;	-----------------------------------------
_ax5043_set_registers_tx:
	C$config.c$144$1$105 ==.
;	..\AX_Radio_Lab_output\config.c:144: AX5043_PLLLOOP                 = 0x09;
	mov	dptr,#_AX5043_PLLLOOP
	mov	a,#0x09
	movx	@dptr,a
	C$config.c$145$1$105 ==.
;	..\AX_Radio_Lab_output\config.c:145: AX5043_PLLCPI                  = 0x02;
	mov	dptr,#_AX5043_PLLCPI
	mov	a,#0x02
	movx	@dptr,a
	C$config.c$146$1$105 ==.
;	..\AX_Radio_Lab_output\config.c:146: AX5043_PLLVCODIV               = 0x20;
	mov	dptr,#_AX5043_PLLVCODIV
	swap	a
	movx	@dptr,a
	C$config.c$147$1$105 ==.
;	..\AX_Radio_Lab_output\config.c:147: AX5043_XTALCAP                 = 0x0C;
	mov	dptr,#_AX5043_XTALCAP
	mov	a,#0x0c
	movx	@dptr,a
	C$config.c$148$1$105 ==.
;	..\AX_Radio_Lab_output\config.c:148: AX5043_0xF00                   = 0x0F;
	mov	dptr,#_AX5043_0xF00
	mov	a,#0x0f
	movx	@dptr,a
	C$config.c$149$1$105 ==.
;	..\AX_Radio_Lab_output\config.c:149: AX5043_0xF18                   = 0x06;
	mov	dptr,#_AX5043_0xF18
	mov	a,#0x06
	movx	@dptr,a
	C$config.c$150$1$105 ==.
...
;------------------------------------------------------------
	...
	C$config.c$153$1$105 ==.
;	..\AX_Radio_Lab_output\config.c:153: __reentrantb void ax5043_set_registers_rx(void) __reentrant
;	-----------------------------------------
;	 function ax5043_set_registers_rx
;	-----------------------------------------
_ax5043_set_registers_rx:
	C$config.c$155$1$107 ==.
;	..\AX_Radio_Lab_output\config.c:155: AX5043_PLLLOOP                 = 0x09;
	mov	dptr,#_AX5043_PLLLOOP
	mov	a,#0x09
	movx	@dptr,a
	C$config.c$156$1$107 ==.
;	..\AX_Radio_Lab_output\config.c:156: AX5043_PLLCPI                  = 0x01;
	mov	dptr,#_AX5043_PLLCPI
	mov	a,#0x01
	movx	@dptr,a
	C$config.c$157$1$107 ==.
;	..\AX_Radio_Lab_output\config.c:157: AX5043_PLLVCODIV               = 0x20;
	mov	dptr,#_AX5043_PLLVCODIV
	mov	a,#0x20
	movx	@dptr,a
	C$config.c$158$1$107 ==.
;	..\AX_Radio_Lab_output\config.c:158: AX5043_XTALCAP                 = 0x0C;
	mov	dptr,#_AX5043_XTALCAP
	mov	a,#0x0c
	movx	@dptr,a
	C$config.c$159$1$107 ==.
;	..\AX_Radio_Lab_output\config.c:159: AX5043_0xF00                   = 0x0F;
	mov	dptr,#_AX5043_0xF00
	mov	a,#0x0f
	movx	@dptr,a
	C$config.c$160$1$107 ==.
;	..\AX_Radio_Lab_output\config.c:160: AX5043_0xF18                   = 0x06;
	mov	dptr,#_AX5043_0xF18
	mov	a,#0x06
	movx	@dptr,a
	C$config.c$161$1$107 ==.
...
;------------------------------------------------------------
	...
	C$config.c$164$1$107 ==.
;	..\AX_Radio_Lab_output\config.c:164: __reentrantb void ax5043_set_registers_rxwor(void) __reentrant
;	-----------------------------------------
;	 function ax5043_set_registers_rxwor
;	-----------------------------------------
_ax5043_set_registers_rxwor:
	C$config.c$166$1$109 ==.
;	..\AX_Radio_Lab_output\config.c:166: AX5043_TMGRXAGC                = 0x00;
	mov	dptr,#_AX5043_TMGRXAGC
	clr	a
	movx	@dptr,a
	C$config.c$167$1$109 ==.
;	..\AX_Radio_Lab_output\config.c:167: AX5043_TMGRXPREAMBLE1          = 0x19;
	mov	dptr,#_AX5043_TMGRXPREAMBLE1
	mov	a,#0x19
	movx	@dptr,a
	C$config.c$168$1$109 ==.
;	..\AX_Radio_Lab_output\config.c:168: AX5043_PKTMISCFLAGS            = 0x03;
	mov	dptr,#_AX5043_PKTMISCFLAGS
	mov	a,#0x03
	movx	@dptr,a
	C$config.c$169$1$109 ==.
...
;------------------------------------------------------------
	...
	C$config.c$172$1$109 ==.
;	..\AX_Radio_Lab_output\config.c:172: __reentrantb void ax5043_set_registers_rxcont(void) __reentrant
;	-----------------------------------------
;	 function ax5043_set_registers_rxcont
;	-----------------------------------------
_ax5043_set_registers_rxcont:
	C$config.c$174$1$111 ==.
;	..\AX_Radio_Lab_output\config.c:174: AX5043_TMGRXAGC                = 0x00;
	mov	dptr,#_AX5043_TMGRXAGC
	clr	a
	movx	@dptr,a
	C$config.c$175$1$111 ==.
;	..\AX_Radio_Lab_output\config.c:175: AX5043_TMGRXPREAMBLE1          = 0x00;
	mov	dptr,#_AX5043_TMGRXPREAMBLE1
	movx	@dptr,a
	C$config.c$176$1$111 ==.
;	..\AX_Radio_Lab_output\config.c:176: AX5043_PKTMISCFLAGS            = 0x00;
	mov	dptr,#_AX5043_PKTMISCFLAGS
	movx	@dptr,a
	C$config.c$177$1$111 ==.
...
;------------------------------------------------------------
	...
	C$config.c$180$1$111 ==.
;	..\AX_Radio_Lab_output\config.c:180: __reentrantb void ax5043_set_registers_rxcont_singleparamset(void) __reentrant
;	-----------------------------------------
;	 function ax5043_set_registers_rxcont_singleparamset
;	-----------------------------------------
_ax5043_set_registers_rxcont_singleparamset:
	C$config.c$182$1$113 ==.
;	..\AX_Radio_Lab_output\config.c:182: AX5043_RXPARAMSETS             = 0xFF;
	mov	dptr,#_AX5043_RXPARAMSETS
	mov	a,#0xff
	movx	@dptr,a
	C$config.c$183$1$113 ==.
;	..\AX_Radio_Lab_output\config.c:183: AX5043_FREQDEV13               = 0x00;
	mov	dptr,#_AX5043_FREQDEV13
	clr	a
	movx	@dptr,a
	C$config.c$184$1$113 ==.
;	..\AX_Radio_Lab_output\config.c:184: AX5043_FREQDEV03               = 0x00;
	mov	dptr,#_AX5043_FREQDEV03
	movx	@dptr,a
	C$config.c$185$1$113 ==.
;	..\AX_Radio_Lab_output\config.c:185: AX5043_AGCGAIN3                = 0xA5;
	mov	dptr,#_AX5043_AGCGAIN3
	mov	a,#0xa5
	movx	@dptr,a
	C$config.c$186$1$113 ==.
...
;------------------------------------------------------------
	...
	C$config.c$190$1$113 ==.
;	..\AX_Radio_Lab_output\config.c:190: __reentrantb void axradio_setup_pincfg1(void) __reentrant
;	-----------------------------------------
;	 function axradio_setup_pincfg1
;	-----------------------------------------
_axradio_setup_pincfg1:
	C$config.c$192$1$115 ==.
;	..\AX_Radio_Lab_output\config.c:192: PALTRADIO = 0x00; //pass through  
	mov	dptr,#_PALTRADIO
	clr	a
	movx	@dptr,a
	C$config.c$193$1$115 ==.
...
;------------------------------------------------------------
	...
	C$config.c$195$1$115 ==.
;	..\AX_Radio_Lab_output\config.c:195: __reentrantb void axradio_setup_pincfg2(void) __reentrant
;	-----------------------------------------
;	 function axradio_setup_pincfg2
;	-----------------------------------------
_axradio_setup_pincfg2:
	C$config.c$197$1$117 ==.
;	..\AX_Radio_Lab_output\config.c:197: PORTR = (PORTR & 0x3F) | 0x00; //AX8052F143 --> no pull-ups on PR6, PR7
	anl	_PORTR,#0x3f
	C$config.c$198$1$117 ==.
...
;------------------------------------------------------------
	...
	C$config.c$603$1$117 ==.
;	..\AX_Radio_Lab_output\config.c:603: int32_t axradio_conv_freq_fromhz(int32_t f)
;	-----------------------------------------
;	 function axradio_conv_freq_fromhz
;	-----------------------------------------
_axradio_conv_freq_fromhz:
	C$config.c$609$1$119 ==.
;	..\AX_Radio_Lab_output\config.c:609: CONSTMULFIX24(0x597a7e);
	mov r0,dpl 
	mov r1,dph 
	mov r2,b 
	mov r3,a 
...
;------------------------------------------------------------
	...
	C$config.c$615$1$119 ==.
;	..\AX_Radio_Lab_output\config.c:615: int32_t axradio_conv_freq_tohz(int32_t f)
;	-----------------------------------------
;	 function axradio_conv_freq_tohz
;	-----------------------------------------
_axradio_conv_freq_tohz:
	C$config.c$621$1$121 ==.
;	..\AX_Radio_Lab_output\config.c:621: CONSTMULFIX24(0x2dc6c00);
	mov r0,dpl 
	mov r1,dph 
	mov r2,b 
	mov r3,a 
	...
	mov r7,a 
;; stage -1 
	.if (((0x2dc6c00)>>16)&0xff) 
	mov a,# (((0x2dc6c00)>>16)&0xff) 
	mov b,r0 
	mul ab 
	mov r7,a 
	mov r4,b 
	...
	.endif 
	.if ((0x2dc6c00)&0xff) 
	mov a,# ((0x2dc6c00)&0xff) 
	mov b,r2 
	mul ab 
	.if (((0x2dc6c00)>>8)&0xffff) 
	add a,r7 
	mov r7,a 
	mov a,b 
	addc a,r4 
...
;; clear precision extension 
	...
	mov r7,a 
;; stage 0 
	.if (((0x2dc6c00)>>24)&0xff) 
	mov a,# (((0x2dc6c00)>>24)&0xff) 
	mov b,r0 
	mul ab 
	add a,r4 
	mov r4,a 
...
;------------------------------------------------------------
	...
	C$config.c$629$1$121 ==.
;	..\AX_Radio_Lab_output\config.c:629: int32_t axradio_conv_freq_fromreg(int32_t f)
;	-----------------------------------------
;	 function axradio_conv_freq_fromreg
;	-----------------------------------------
_axradio_conv_freq_fromreg:
	C$config.c$635$1$123 ==.
;	..\AX_Radio_Lab_output\config.c:635: CONSTMULFIX16(0x1000000);
	mov r0,dpl 
	mov a,dph 
	mov r1,a 
	push acc 
...
;------------------------------------------------------------
	...
	C$config.c$641$1$123 ==.
;	..\AX_Radio_Lab_output\config.c:641: int32_t axradio_conv_timeinterval_totimer0(int32_t dt)
;	-----------------------------------------
...
_axradio_conv_timeinterval_totimer0:
	...
	mov	r6,b
	mov	r7,a
	C$config.c$648$1$125 ==.
;	..\AX_Radio_Lab_output\config.c:648: dt >>= 6;
	mov	a,r5
	mov	c,acc.7
	xch	a,r4
	rlc	a
...
00103$:
	mov	r7,a
	C$config.c$649$1$125 ==.
;	..\AX_Radio_Lab_output\config.c:649: r = dt;
	mov	ar0,r4
	mov	ar1,r5
	mov	ar2,r6
	C$config.c$650$1$125 ==.
;	..\AX_Radio_Lab_output\config.c:650: dt >>= 2;
	mov	a,r7
	mov	r3,a
	mov	c,acc.7
	rrc	a
	...
	rrc	a
	mov	r4,a
	C$config.c$651$1$125 ==.
;	..\AX_Radio_Lab_output\config.c:651: r -= dt;
	mov	a,r0
	clr	c
	subb	a,r4
	mov	r0,a
	...
	subb	a,r7
	mov	r3,a
	C$config.c$652$1$125 ==.
;	..\AX_Radio_Lab_output\config.c:652: dt >>= 2;
	mov	a,r7
	mov	c,acc.7
	rrc	a
	mov	r7,a
	...
	rrc	a
	mov	r4,a
	C$config.c$653$1$125 ==.
;	..\AX_Radio_Lab_output\config.c:653: r -= dt;
	mov	a,r0
	clr	c
	subb	a,r4
	mov	r0,a
	...
	subb	a,r7
	mov	r3,a
	C$config.c$654$1$125 ==.
;	..\AX_Radio_Lab_output\config.c:654: dt >>= 3;
	mov	a,r5
	swap	a
	rl	a
	xch	a,r4
...
00104$:
	mov	r7,a
	C$config.c$655$1$125 ==.
;	..\AX_Radio_Lab_output\config.c:655: r += dt;
	mov	a,r4
	add	a,r0
	mov	r0,a
	mov	a,r5
	...
	mov	a,r7
	addc	a,r3
	C$config.c$656$1$125 ==.
;	..\AX_Radio_Lab_output\config.c:656: return r;
	mov	dpl,r0
	mov	dph,r1
	mov	b,r2
	C$config.c$657$1$125 ==.
...
;------------------------------------------------------------
	...
	C$config.c$659$1$125 ==.
;	..\AX_Radio_Lab_output\config.c:659: __reentrantb uint8_t axradio_byteconv(uint8_t b) __reentrant
;	-----------------------------------------
;	 function axradio_byteconv
;	-----------------------------------------
_axradio_byteconv:
	C$config.c$661$1$127 ==.
;	..\AX_Radio_Lab_output\config.c:661: return b;
	C$config.c$662$1$127 ==.
...
;------------------------------------------------------------
	...
	C$config.c$665$1$127 ==.
;	..\AX_Radio_Lab_output\config.c:665: __reentrantb void axradio_byteconv_buffer(uint8_t __xdata *buf, uint16_t buflen) __reentrant
;	-----------------------------------------
...
_axradio_byteconv_buffer:
	push	_bp
	mov	_bp,sp
	C$config.c$667$1$127 ==.
;	..\AX_Radio_Lab_output\config.c:667: }
	pop	_bp
	C$config.c$667$1$127 ==.
...
;------------------------------------------------------------
	...
	C$config.c$669$1$127 ==.
;	..\AX_Radio_Lab_output\config.c:669: __reentrantb uint16_t axradio_framing_check_crc(uint8_t __xdata *pkt, uint16_t cnt) __reentrant
;	-----------------------------------------
...
_axradio_framing_check_crc:
	...
	mov	r6,dpl
	mov	r7,dph
	C$config.c$671$1$131 ==.
;	..\AX_Radio_Lab_output\config.c:671: if (crc_crc16(pkt, cnt, 0xFFFF) != 0xB001)
	mov	r5,#0x00
	mov	a,#0xff
	push	acc
	push	acc
	...
	sjmp	00102$
00108$:
	C$config.c$672$1$131 ==.
;	..\AX_Radio_Lab_output\config.c:672: return 0;
	mov	dptr,#0x0000
	sjmp	00103$
00102$:
	C$config.c$673$1$131 ==.
;	..\AX_Radio_Lab_output\config.c:673: return cnt;
	mov	a,_bp
	add	a,#0xfc
	mov	r0,a
	mov	dpl,@r0
...
;------------------------------------------------------------
	...
	C$config.c$676$1$131 ==.
;	..\AX_Radio_Lab_output\config.c:676: __reentrantb uint16_t axradio_framing_append_crc(uint8_t __xdata *pkt, uint16_t cnt) __reentrant
;	-----------------------------------------
...
_axradio_framing_append_crc:
	...
	mov	r6,dpl
	mov	r7,dph
	C$config.c$679$1$133 ==.
;	..\AX_Radio_Lab_output\config.c:679: s = crc_crc16(pkt, cnt, s);
	mov	ar3,r6
	mov	ar4,r7
	mov	r5,#0x00
	push	ar7
	...
	pop	ar6
	pop	ar7
	C$config.c$680$1$133 ==.
;	..\AX_Radio_Lab_output\config.c:680: pkt += cnt;
	mov	a,_bp
	add	a,#0xfc
	mov	r0,a
	mov	a,@r0
	...
	addc	a,r7
	mov	r7,a
	C$config.c$681$1$133 ==.
;	..\AX_Radio_Lab_output\config.c:681: *pkt++ = ~(uint8_t)(s);
	mov	ar3,r4
	mov	a,r3
	cpl	a
	mov	dpl,r6
	...
	mov	r6,dpl
	mov	r7,dph
	C$config.c$682$1$133 ==.
;	..\AX_Radio_Lab_output\config.c:682: *pkt++ = ~(uint8_t)(s >> 8);
	mov	ar4,r5
	mov	a,r4
	cpl	a
	mov	dpl,r6
	mov	dph,r7
	movx	@dptr,a
	C$config.c$683$1$133 ==.
;	..\AX_Radio_Lab_output\config.c:683: return cnt + 2;
	mov	a,_bp
	add	a,#0xfc
	mov	r0,a
	mov	dpl,@r0
...
_axradio_phy_chanfreq:
	.byte #0xef,#0xee,#0x16,#0x12	; 303492847
...
_axradio_phy_maxfreqoffset:
	.byte #0x22,#0x47,#0x00,#0x00	;  18210
