...
// TX: fcarrier=868.300MHz dev=  0.000kHz br=100.000kBit/s pwr= 15.0dBm
// RX: fcarrier=868.300MHz bw=150.000kHz br=100.000kBit/s
...
__reentrantb void ax5043_set_registers(void) __reentrant
{
	...
	AX5043_MAXRFOFFSET1            = 0x17;
	AX5043_MAXRFOFFSET0            = 0xB6;
	...
	AX5043_FREQUENCYGAINC0         = 0x05;
	AX5043_FREQUENCYGAIND0         = 0x05;
	...
	AX5043_FREQUENCYGAINC1         = 0x05;
	AX5043_FREQUENCYGAIND1         = 0x05;
	...
	AX5043_FREQUENCYGAINC3         = 0x09;
	AX5043_FREQUENCYGAIND3         = 0x09;
...
const int32_t __code axradio_phy_maxfreqoffset = 18210;
...
const int8_t __code axradio_phy_channelbusy = -85 + 64;
...
const uint16_t __code axradio_phy_preamble_wor_longlen = 93; // wor_longlen + wor_len totals to 240.0ms plus 32bits
const uint16_t __code axradio_phy_preamble_wor_len = 224;
...
const uint32_t __code axradio_framing_ack_timeout = 4; // 4.1ms in wtimer0 units (640Hz)
...
// synchronous mode
const uint32_t __code axradio_sync_period = 1328; // ACTUALLY FREQ, NOT PERIOD!
const uint32_t __code axradio_sync_xoscstartup = 49;
const uint32_t __code axradio_sync_slave_syncwindow = 3982; // 0.121s
...
const int16_t __code axradio_sync_slave_maxperiod = 1617; // in (2^SYNC_K1) * wtimer0 units
...
const uint32_t __code axradio_sync_slave_rxadvance[] = { 133, 97, 139 };// 4.057ms, 2.958ms, 4.240ms
const uint32_t __code axradio_sync_slave_rxwindow[] = { 134, 62, 146 }; // 4.087ms, 1.890ms, 4.453ms
const uint32_t __code axradio_sync_slave_rxtimeout = 51; // 1.5ms, maximum duration of a packet
